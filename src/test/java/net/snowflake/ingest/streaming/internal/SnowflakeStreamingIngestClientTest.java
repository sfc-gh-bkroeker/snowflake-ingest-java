  ...
  public void testRegisterBlobRequestCreationSuccess() throws Exception {
    ...
    ChannelMetadata channelMetadata =
        ChannelMetadata.builder()
            ...
            .setRowSequencer(((ChannelRuntimeState)channel.getChannelState()).incrementAndGetRowSequencer())
  ...
  private Pair<List<BlobMetadata>, Set<ChunkRegisterStatus>> getRetryBlobMetadata() {
    ...
    ChannelMetadata channelMetadata1 =
        ChannelMetadata.builder()
            ...
            .setRowSequencer(((ChannelRuntimeState)channel1.getChannelState()).incrementAndGetRowSequencer())
    ...
    ChannelMetadata channelMetadata2 =
        ChannelMetadata.builder()
            ...
            .setRowSequencer(((ChannelRuntimeState)channel2.getChannelState()).incrementAndGetRowSequencer())
    ...
    ChannelMetadata channelMetadata3 =
        ChannelMetadata.builder()
            ...
            .setRowSequencer(((ChannelRuntimeState)channel3.getChannelState()).incrementAndGetRowSequencer())
    ...
    ChannelMetadata channelMetadata4 =
        ChannelMetadata.builder()
            ...
            .setRowSequencer(((ChannelRuntimeState)channel4.getChannelState()).incrementAndGetRowSequencer())
